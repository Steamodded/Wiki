...
- `font`: set the text font.<br>
 ...
 The key needed is the same as the number or string you would provide in `{f:}` during [localization](https://docs.smods.dev/Guides/Text-Styling#text-font-modifier-f)
