...
- **Optional parameters** *(defaults)*:
  ...
  - `atlas_table = 'ASSET_ATLAS'`
    ...
    - Use `ANIMATION_ATLAS` for AnimatedSprites (see [guide](https://docs.smods.dev/API%20Documentation/Animated-Sprites/))
    - Use `STATE_ATLAS` for StateSprites (see [guide](https://docs.smods.dev/API%20Documentation/Animated-Sprites/))
  ...
  - `sprite_args`: for animated sprites, may contain default `sprite_args` arguments for created sprites. If a `sprite_args` table is passed to `SMODS.create_sprite()`, its arguments take priority if defined. (see [guide](https://docs.smods.dev/API%20Documentation/Animated-Sprites/) for `Animated/StateSprite`s)
