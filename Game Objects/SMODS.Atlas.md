...
- **Optional parameters** *(defaults)*:
  ...
  - `force_pixel`: Always load the 1x sprite and force pixel smoothing off for this atlas. Useful for lower resolution pixel art that looks odd with smoothing enabled.
